...
-->
<template>
    <div class="overflow-hidden py-16 px-6 lg:px-8 xl:py-36">
      <div class="mx-auto max-w-max lg:max-w-7xl">
        <div class="relative z-10 mb-8 md:mb-2 md:px-6">
          <div class="max-w-prose text-base lg:max-w-none">
            ...
            <p class="mt-2 text-3xl font-bold leading-8 tracking-tight text-gray-500 sm:text-4xl">A better way to send money</p>
          </div>
        </div>
        <div class="relative">
          ...
          <div class="relative md:bg-black md:p-6">
            <div class="lg:grid lg:grid-cols-2 lg:gap-6">
              <div class="prose prose-lg prose-indigo text-gray-200 lg:max-w-none">
              ...
              <div class="prose prose-lg prose-indigo mt-6 text-gray-200 lg:mt-0">
